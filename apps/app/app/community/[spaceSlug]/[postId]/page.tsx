      ...
      <section className="mt-10 border-t border-zinc-200 pt-6">
        ...
        <ul className="space-y-4">
          {post.comments.map((comment) => (
            <li key={comment.id} className="rounded-lg bg-zinc-50 p-3">
        ...
        {user && (
          ...
          >
            ...
            />
            <button className="self-start rounded-md bg-zinc-900 px-4 py-1.5 text-sm font-medium text-white hover:bg-zinc-700">
              Comment
            </button>
          </form>
        )}
